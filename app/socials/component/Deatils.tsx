...
const text:string="Looking for a running or exercise partner, or a team to play sports?"
const Deatils = () => {
  return (
    <>
      <div className="w-full lg:h-[100vh] lg:p-4 border border-gray-900">
        ...
        >
          <motion.h1
            ...
            transition={{ duration: 1, ease: "easeIn" }}
          >
            "Tired of asking to join a team at the ground? We've got a better
            way!"
          </motion.h1>
          <div className="lg:max-w-[850px] w-full mx-auto p-2">
            ...
            >
              ...
              like-minded sports and fitness enthusiasts—all from the comfort of
              your home."{" "}
            </motion.p>
          </div>
      ...
      <div className="lg:max-w-[1300px] flex gap-2 lg:p-2 mt-5 lg:flex-row flex-col mx-auto flex-wrap w-full">
          {
            imgaraay.map(item => {
                ...
                transition={{duration:1,ease:"easeIn"}}>
                <Image src={item.src} alt={item.alt} className=" w-[300px] object-fill" loading="lazy"/>
